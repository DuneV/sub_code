...
// extern std::map<std::string, std::function<void()>> movement;

// matrix

//extern std::array<std::array<std::function<void()>, 3>, 3> movement;

//std::array<std::function<void()>, 3> functions = {&gpio_config, &motor_init, &motor_init};
